...
function Productview() {
  ...
  if (!item) return <h2 className="text-center text-xl">Loading.....</h2>;
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex justify-center">
      <div className="bg-white shadow-xl p-6 rounded-xl max-w-3xl w-full">
        <Link
          to="/"
          className="text-white bg-green-400 mb-4 inline-block px-4 py-2 rounded"
        >
          back
        </Link>
        <div className="flex-column flex md:flex-row gap-6">
          <img
            src={item.thumbnail}
          ...
          <div>
            ...
            <div className="mt-6 flex gap-4 items-center">
              ...
              <a
                ...
                className="flex items-center gap-2 px-4 py-3 rounded-lg text-white bg-green-500"
              >
                <svg
